...
\node [shift={(-0.2,-2.5,0)}, align=center] at (pn1-east) {feature \\extraction};
...
\node [shift={(0.5,-2.2,0)}, align=center] at (bin-west) {ROI\\proposal\\};
...
\pic[shift={(2.2,0,0)}] at (bin-east) {Box={name=crop,%
        xlabel={{"","dummy"}},fill=\ConvColor,opacity=0.7,height=10,width=5,depth=10}};
\node [shift={(-0.3,-2.2,0)},align=center] at (crop-west) {crop};
...
(-0.2,3,0) -- (18,3,0) -- (18,3,0) -- (25,3,0) -- (25,-5,0) -- (-0.2, -5, 0) -- cycle;
\node [shift={(12.5,-5.5,0)},align=center] at (0,0,0) {point cloud encoder};

\draw [dot diameter=4pt,dot spacing=6pt,dots, color=blue]
(18.5,8,0) -- (33.5,8,0) -- (33.5,-5,0) -- (25.5,-5,0) -- (25.5,3.5,0) -- (18.5, 3.5, 0) -- cycle;
\node [shift={(29.5,-5.5,0)},align=center] at (0,0,0) {pre-training};
\end{tikzpicture}
\end{document}\grid